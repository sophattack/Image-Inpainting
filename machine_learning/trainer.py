...
class Trainer(nn.Module):
    def __init__(self, config):
        ...
        self.localD = LocalDis(self.config['netD'], self.config['mask_shape'], self.use_cuda, self.device_ids)
        self.globalD = GlobalDis(self.config['netD'], self.config['image_shape'], self.use_cuda, self.device_ids)
